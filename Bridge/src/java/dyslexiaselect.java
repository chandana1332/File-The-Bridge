 ...
 * @author CHANDANA
 */
public class dyslexiaselect extends HttpServlet {
...
//P.println("driver loaded");
            ...
            String q = "select DYSLEXIA from generaldetails where NAME='" + s1 + "';";
            P.println("query......" + q);
            ...
            if (y.equalsIgnoreCase(s2)) {
                ...
                rd = req.getRequestDispatcher("/dyslexiaselect.jsp");
                rd.forward(req, res);
            } else {
                P.println("n");
                req.setAttribute("name", s1);
