 ...
 * @author CHANDANA
 */
public class activitydyslexia extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            if (!s8.isEmpty()) {
                ...
                String q4 = "insert into actidyslexia values('" + s1 + "','" + s2 + "','" + s04 + "','0','0','0','0','0');";
                String q5 = "insert into actidyslexia values('" + s1 + "','" + s2 + "','" + s05 + "','0','0','0','0','0');";
            ...
            if (b) {
                ...
                rd = req.getRequestDispatcher("/addeddyslexia.jsp");
                rd.forward(req, res);
            } else {
