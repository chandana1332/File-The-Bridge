 ...
 * @author CHANDANA
 */
public class activity1dysgraphia extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            String q = "select DISTINCT ACTIVITY from actidysgraphia where NAME='" + name + "';";
            ...
            for (w = 0; w < i; w++) {
                ...
                String q1 = "select PARAMETERS,NUMBER_OF_TIMES from actidysgraphia where activity='" + s[w] + "';";
                ...
                for (k = 0; k < j; k++) {
                    if (n[k].equalsIgnoreCase(zero)) {
                        ...
                        String q2 = "update actidysgraphia set VAL1='" + val[k] + "',RECENT_VAL='" + val[k] + "',NUMBER_OF_TIMES=NUMBER_OF_TIMES+1 where NAME='" + name + "' and ACTIVITY='" + s[w] + "' and PARAMETERS='" + m[k] + "'";
                        System.out.println(q2);
                        succ = stmt.executeUpdate(q2);

                    } else if (n[k].equalsIgnoreCase(eleven)) {
                        String q2 = "update actidysgraphia set VAL11='" + val[k] + "',RECENT_VAL='" + val[k] + "',NUMBER_OF_TIMES=NUMBER_OF_TIMES+1 where NAME='" + name + "' and ACTIVITY='" + s[w] + "' and PARAMETERS='" + m[k] + "'";
                        System.out.println(q2);
                        succ = stmt.executeUpdate(q2);

                    } else if (n[k].equalsIgnoreCase(tt)) {
                        String q2 = "update actidysgraphia set VAL21='" + val[k] + "',RECENT_VAL='" + val[k] + "',NUMBER_OF_TIMES=NUMBER_OF_TIMES+1 where NAME='" + name + "' and ACTIVITY='" + s[w] + "' and PARAMETERS='" + m[k] + "'";
                        System.out.println(q2);
                        succ = stmt.executeUpdate(q2);
            ...
            if (b) {
                ...
                rd = req.getRequestDispatcher("/updateddysgraphia.jsp");
                rd.forward(req, res);
            } else {
