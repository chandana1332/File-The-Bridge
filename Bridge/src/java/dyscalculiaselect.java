 ...
 * @author CHANDANA
 */
public class dyscalculiaselect extends HttpServlet {
...
//P.println("driver loaded");
            ...
            String q = "select DYSCALCULIA from generaldetails where NAME='" + s1 + "';";
            P.println("query......" + q);
            ...
            if (y.equalsIgnoreCase(s2)) {
                ...
                rd = req.getRequestDispatcher("/dyscalculiaselect.jsp");
                rd.forward(req, res);
            } else {
                P.println("n");
                req.setAttribute("name", s1);
