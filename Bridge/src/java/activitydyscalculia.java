 ...
 * @author CHANDANA
 */
public class activitydyscalculia extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            if (!s8.isEmpty()) {
                ...
                String s04 = s2 + '_' + s7;
                String s05 = s2 + '_' + s8;
                String q = "insert into actidyscalculia values('" + s1 + "','" + s2 + "','" + s0 + "','0','0','0','0','0');";
                String q1 = "insert into actidyscalculia values('" + s1 + "','" + s2 + "','" + s01 + "','0','0','0','0','0');";
                String q2 = "insert into actidyscalculia values('" + s1 + "','" + s2 + "','" + s02 + "','0','0','0','0','0');";
                String q3 = "insert into actidyscalculia values('" + s1 + "','" + s2 + "','" + s03 + "','0','0','0','0','0');";
                String q4 = "insert into actidyscalculia values('" + s1 + "','" + s2 + "','" + s04 + "','0','0','0','0','0');";
                String q5 = "insert into actidyscalculia values('" + s1 + "','" + s2 + "','" + s05 + "','0','0','0','0','0');";
            ...
            if (b) {
                ...
                rd = req.getRequestDispatcher("/addeddyscalculia.jsp");
                rd.forward(req, res);
            } else {
