 ...
 * @author CHANDANA
 */
public class intake4dyslexia extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            String[] dyslexia = req.getParameterValues("dyslexia");
            String y = "YES";
            String n = "NO";
            int ssize = dyslexia.length;
            P.println(ssize);
            ...
            if (ssize >= 6) {
                ...
                ResultSet rs = null;
                for (i = 0; i < ssize; i++) {
                    String q = "insert into dyslexiasymptoms values('" + s1 + "','" + dyslexia[i] + "')";
                    P.println(q);
                    a = stmt1.executeUpdate(q);
                }
                String q1 = "update generaldetails set DYSLEXIA='" + y + "' where NAME='" + s1 + "';";
