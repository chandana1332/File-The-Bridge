 ...
 * @author CHANDANA
 */
public class intake4dyscalculia extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        try {
            ...
            String[] dyscalculia = req.getParameterValues("dyscalculia");
            String y = "YES";
            String n = "NO";
            int ssize = dyscalculia.length;
            P.println(ssize);
            ...
            if (ssize >= 6) {
                ...
                ResultSet rs = null;
                for (i = 0; i < ssize; i++) {
                    String q = "insert into dysgraphiasymptoms values('" + s1 + "','" + dyscalculia[i] + "')";
                    P.println(q);
                    a = stmt1.executeUpdate(q);
                }
                String q1 = "update generaldetails set DYSCALCULIA='" + y + "' where NAME='" + s1 + "';";
