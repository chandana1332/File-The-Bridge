...
<body>
  <form action="activity1dyscalculia"/>
  <div id="body">
  <div id="top_bg">
...
String q="select DISTINCT ACTIVITY from actidyscalculia where NAME='"+name+"';";
               ...
               while(rs.next())
                ...
                for(w=0;w<i;w++)
                                       {
                            String q1="select PARAMETERS,RECENT_VAL from actidyscalculia where activity='"+s[w]+"';";
...
{                                                                                                                               
    ...
    <input type="text" name="name"value="<%=name%>" />
        ...
        <a href="addactdyscalculia.jsp?user=<%=name%>">ADD ACTIVITY</a>
