...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form action="activity1dysgraphia"/>
        <div id="body">
            <div id="top_bg">
                ...
                <div id="content_single">
                    ...
                    for(w=0;w<i;w++)
                        {
                        String q1="select PARAMETERS,RECENT_VAL from actidysgraphia where activity='"+s[w]+"';";
                        ...
                        for(k=0;k<j;k++)
                            ...
                            <a href="addactdysgraphia.jsp?user=<%=name%>">ADD ACTIVITY</a>
